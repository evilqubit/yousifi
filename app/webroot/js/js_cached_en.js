...
function get_sub_content(loc , section_id , parent_id,title){
	 $.ajax({
			url: loc,
			beforeSend:function(data){
...
function get_content(loc , section_id,title){
	//alert(section_id);
	//Get the title of the selected id
...
function show_submenu(id,title,url){
	//alert(title);
	...
	//$(".slicknav_nav").slideUp(500);
	 ...
	 $.ajax({
			...
			complete: function(){
				...
				$(".leftMenuRow").removeClass("activeLeftMenu");
				$(".leftMenu_"+id).addClass('activeLeftMenu');
