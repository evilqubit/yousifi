...
$view_location="/admin/$controllerName/cvs/";
$view_name="Album";
                        ...
                        <div class="box">
                          ...
                          <div class="box-content">
                               ...
                               <div class="btn-toolbar pull-left clearfix">
                                ...
                                <!--  <div  style="width:160px; color:#ffffff; margin-bottom: 10px; font-size: 15px; padding: 10px;  float:left;background-color: #b6d1f2;text-shadow: 0 1px 0 #aecef4;clear:left;">                              
                                <a  style="width: 160px; display: block; color: #ffffff;" href="/admin/Jobs/order_all_entries/">Order all Alphabetical</a></div> -->
								        ...
								        <tr  class="table-flag-orange   " id="row_<?php echo $id;?>">
								            ...
								            <td class="handle">
								                ...
								                <!-- <a target="_blank" class="btn btn-small show-tooltip" title="Preview" href="http://<?php echo $_SERVER['HTTP_HOST']; ?><?php echo $this->Html->url(array('admin' => false,'action'=>'view',$newsEntry["$modelName"]['id'])); ?>"><i class="icon-zoom-in"></i></a> -->
								               	...
								               	<a class="btn btn-small show-tooltip" href="<?=$view_location."/$id"?>" title="View Submited CVs"><i class="icon-zoom-in"></i></a>
