...
<form id="PageForm" class="form-horizontal" accept-charset="utf-8" method="post" action="/admin/<?=$controllerName?>/add/" novalidate="novalidate">
    ...
    <div class="box">
        ...
        <div class="box-content">
       		...
       		<!-- <div class="control-group">
				...
				<div class="input_div" style='float:left' ><?php echo $this->Form->input("$modelName.email",array('type'=>'text', 'escape' => false,'label'=>false));?></div>
			</div> -->
			...
			<?php 
					...
					echo $this->Form->input("$modelName.text.".$local,array('id'=>'content_'.$code,'class'=>'input-xlarge','type'=>'textarea',
						'style'=>'margin-bottom:20px',
						'label' => array(
				        'class' => 'control-label',
					 ...
					 echo $this->Ck->load('content_'.$code,$code); 
