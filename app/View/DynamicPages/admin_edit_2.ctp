...
<form type='file'  enctype="multipart/form-data"    id="PageForm" class="form-horizontal" accept-charset="utf-8" method="post" action="/admin/<?=$controllerName?>/edit_2/<?=$id?>" novalidate="novalidate">
...
//					if(isset($pointer)  && !empty($pointer)){
						$display='';
//					}else{
//						$display='none';
//					}	
