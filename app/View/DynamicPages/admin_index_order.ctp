...
$search_location="/admin/$controllerName/index_order";
          ...
          <div class="box-content">
            	...
            	<div class="btn-toolbar pull-left clearfix">
					<div class="control-group">
						<div class="controls">
							    <?=$this->element("/admin/index_search" , array(
                ...
                <a  style="width: 80px; display: block; color: #ffffff;" href="<?=$order_all?>">Order all</a>
                  	...
                  	<div class="tableHeaderContainer">
                  		<div class="table_headerRow" style="width: 270px;">Title</div>	  
                  		<!-- <div class="table_headerRow" style="width: 200px;">Section</div>	                              		 -->
                  		<div  class="table_headerRow" style="width: 200px;">Modified</div>	                              		
                  		<div  class="table_headerRow" style="width: 500px; text-align: right">Action</div>
                  	</div>
				    ...
				    <div class="table2sort"  id="mainList">
					     ...
					     foreach($data as $newsEntry){
							...
							$sub_section=$newsEntry["$modelName"]['section'];
							//var_dump($sub_section);exit;
							
							$section='';
							if($sub_section == 'our_business_local'){
								$section = 'Our Business Local';
							}
							
							if($sub_section == 'our_business_international'){
								$section = 'Our Business International';
							}
							...
							$del_div="<a class='btn btn-small btn-danger show-tooltip' title='Delete' onclick='delete_entry(\"/admin/$controllerName/delete/$id\",\"row_$id\",\"del_div_$id\");return false;' href='/admin/$controllerName/delete/$id'>Delete</a>";
					     	...
					     	<div class="table-flag-orange "  style="width: 100%; float: left;"   id="row_<?php echo $uniqe_id;?>">
						        <div  class="rowContainer" style="background-color: <?=$back_color?>" >
						            <div class="handle" style="width: 25%; float: left;"><?php echo $title; ?></div>
								<!-- 	<div class="handle" style="width: 25%; float: left;"><?php echo $section; ?></div> -->
						            ...
						            <div class=""  style="width: 50%; float: left; text-align: right">
						                <div class="btn-group">
						                <div class="accordAjaxLoader" id="accordAjaxLoader_<?=$uniqe_id?>" ><img src="/img/ajax-loader.gif" width="20" height="20" alt=""/></div>
...
$(document).ready(function() {
	...
	$("#mainList").sortable({
		...
		update : function () {
			...
			$("#info").load("/admin/<?php echo $controllerName;?>/ajax_order2//page:<?=$page_number?>?"+order);
		}
	});
