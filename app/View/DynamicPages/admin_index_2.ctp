...
$edit_location="/admin/$controllerName/edit_2/";
$delete_location="/admin/$controllerName/delete/";
$add_location="/admin/$controllerName/add_2/$section/";
...
$search_location="/admin/$controllerName/index_2/$section/";
        ...
        <div class="box">
          ...
          <div class="box-content">
            	...
            	<div class="btn-toolbar pull-right clearfix">
                    ...
                    <div class="btn-group">
                        <?php echo $this->Html->link('Refresh',array('action'=>'admin_index_2/'.$section),array('class'=>'btn')); ?>          
                     </div>
                </div>
						        ...
						        <div  class="rowContainer" style="background-color: <?=$back_color?>" >
						            ...
						            <div class=""  style="width: 40%; float: left; text-align: right">
						                ...
						                <div class="accordAjaxLoader" id="accordAjaxLoader_<?=$uniqe_id?>" ><img src="/img/ajax-loader.gif" width="20" height="20" /></div>
						              	...
						              	<div class="btn btn-small show-tooltip btn-success" style="background-color: #b6d1f2; margin-right: 2px;" onclick="get_dynamicPages_subchildren('<?=$id?>' , '<?=$section?>')" title="Manage pages">Manage pages</div>        
