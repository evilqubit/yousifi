...
<button class="FloatClass submit_btn" style="clear:both;margin-bottom:10px;" onclick="window.location='/admin/<?=$controllerName?>/index_by_section/<?=$sourceModel?>/<?=$section?>/1'">Order all entries</button>
