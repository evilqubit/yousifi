...
$order_all="/admin/$controllerName/index/$section/1";
                        ...
                        <div class="box">
                          ...
                          <div class="box-content">
                               ...
                               <div class="btn-toolbar pull-left clearfix">
								...
								<?php if($section != 'kids_zone') {?>
								<!-- <div class="control-group" style="clear: both;">
									<label class="control-label" for="JobPublish">Filter by Category</label>
									<div class="input_div" style='float:left' ><?php 
									$url="/admin/Shops/index/$section/";
									echo $this->Form->input("$modelName.category_id",array(
									'id'=>'category_list',
									'selected'=>$category_id,
									'empty'=>'all categories',
									'onchange'=>"category_change('$url')",
									'options'=>$category_list,'escape' => false,'label'=>false));?></div>
								</div> -->
								<?php  } ?>
                                ...
                                <a  style="width: 80px; display: block; color: #ffffff;" href="<?=$order_all?>">Order all</a></div>
								    ...
								    <tbody class="table2sort">
								     ...
								     <?php foreach($data as $newsEntry){
								        ...
								        <tr  class="table-flag-orange   " id="row_<?php echo $id;?>">
								           ...
								           <?php if($section == 'articles'){ ?>
								           <td class="handle"><?php echo $date ?></td>
								           <?php } ?>
								            ...
								            <td class="handle">
								                ...
								                <?php if($section == 'articles'){ ?>
								                	<!-- <a class="btn btn-small show-tooltip" href="<?=$related_images_location."/$id"?>" title="Related Images"><i class="icon-picture"></i></a> -->
