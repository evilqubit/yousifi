...
if($lang == 'en'){
 ...
 ?>
<div id="recaptcha_widget" style="display:none;margin-bottom:10px; float:<?=$float?>">
	...
	<input style="text-transform:none;" type="text" id="<?php echo $val_id;?>" name="<?php echo $val_id;?>" class="<?php echo $className;?>" style="margin-top:1px;" />
