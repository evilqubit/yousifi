                          ...
                          <div class="box-content">
                               ...
                               <div class="btn-toolbar pull-left clearfix">
                                ...
                                <div class="btn-toolbar pull-right clearfix">
                                    ...
                                    <div class="btn-group">
                           				 <?php echo $this->Html->link('Refresh',array('action'=>'admin_index/'.$section),array('class'=>'btn')); ?>          
                                    </div>
                                </div>
                                ...
                                <?php
                                if($section == 'about_us' || $section == 'our_business' || $section == 'our_brands' || $section =='careers'){
                                	?>
                                	<div id="info" style="width:550px; color:#ffffff; margin-bottom: 10px; font-size: 15px; padding: 10px;  float:left;background-color: #b6d1f2;text-shadow: 0 1px 0 #aecef4;clear:left;">Please note the first ordered image will be selected only </div>
								...
								<table class="table table-advance" id="table2">
								    ...
								    <tbody class="table2sort">
								     ...
								     foreach($data as $newsEntry){
										...
										$image=$newsEntry["$modelName"]['image'];
