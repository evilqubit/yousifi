    ...
    <div class="box">
        ...
        <div class="box-content">
			...
			<div class="all_sections" id="image_section" >					
				<?php			
				 echo $this->element("/admin/images/upload_one_image",array('userFilesFolder'=>$userFilesFolder, "preferred_size"=>$preferred_size ,'title'=>"Cover Photo" , "modelName"=>$modelName));	
				?>
			</div>
