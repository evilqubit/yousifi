    ...
    <div class="box">
        ...
        <div class="box-content">
			...
			<div class="tab-pane active" id="tab-1-1">
				...
				<!-- cover photo  -->
				<div class="all_sections" id="image_section" >					
					<?php			
					echo $this->element("/admin/images/upload_one_image",array( 'required'=>1, 'userFilesFolder'=>$userFilesFolder, "preferred_size"=>$preferred_size ,'title'=>"Cover Photo" , "modelName"=>$modelName));	
					?>
				</div>
			...
			<span class="language <?php echo $code; ?>">
	       	...
	       	<?php 	       		
	       		if($section == 'home' || $section == 'middle' || $section == 'categories'){
	       	?>
			...
			if($section == 'home' || $section == 'categories'){		
				echo $this->Form->input("$modelName.text.".$local,array('id'=>'content_'.$local,'class'=>'input-xlarge','type'=>'textarea','dir'=>$direction,
					'style'=>'margin-bottom:20px',
					'label' => array(
			        'class' => 'control-label',
