    ...
    <div class="floatClass vidoeLayer">
		...
		$video_type=$data["Banner"]['video_type'];
		$youtube=$data["Banner"]['youtube'];
		$video=$data["Banner"]['video'];
		$video_image=$data["Banner"]['video_image'];
		...
		<?php 	
			...
			$video_url="/files/banners/video/flv/$video";
			$video_image="/files/banners/preview/$video_image";
			//print $video_url;exit;
