...
<form id="PageForm" class="form-horizontal" accept-charset="utf-8" method="post" action="/admin/<?=$controllerName?>/shop_online/<?=$id?>" novalidate="novalidate">
    ...
    <div class="box">
        ...
        <div class="box-content">
			...
			<div class="control-group">
				<label class="control-label" for="JobPublish">Shop Online</label>
				<div class="input_div" style='float:left' ><?php echo $this->Form->input("$modelName.shop_online",array('type'=>'text' ,'class'=>'url', 'escape' => false,'label'=>false));?></div>
			</div>
